    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 6,
          name: 'Pawn Language',
          imageUrl: 'https://raw.githubusercontent.com/pawn-lang/compiler/refs/heads/master/source/bin/pawn.ico',
          status: 'Advance'
        },
        {
          id: 7,
        ...
        },
        {
          id: 8,
          name: 'Discord JS',
          imageUrl: 'https://img.icons8.com/?size=100&id=ytC17YjDcKHo&format=png&color=000000',
          status: 'Advance'
        },
        {
          id: 9,
        ...
        },
        {
          id: 11,
          name: 'C++',
          imageUrl: 'https://img.icons8.com/?size=100&id=shQTXiDQiQVR&format=png&color=000000',
          status: 'Intermediate'
        },
        {
          id: 12,
      ...
      <section
        ...
        <div class="md:w-7/12">
          ...
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; For me, programming ain’t just about typing lines of code – it’s more like art, where every logic, function, and feature gotta flow with some style. I like to build stuff that’s not only functional and user-friendly but also got that vibe that makes people go “damn, this works nice!”
            So if you’re lookin’ for someone who can cook up some backend magic, set up game server systems, or craft a website with personality – hit me up, cuzz.
          </p>
        </div>
